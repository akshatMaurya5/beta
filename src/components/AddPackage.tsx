...
//     useEffect(() => {
//         // Fetch packages from API when query changes
...
//                     }));
//                     setResults(packages);
//                     localStorage.setItem('searchResults', JSON.stringify(packages)); // Store results in local storage
//                 } catch (error) {
...
//         const selectedPackageDetails = { name: selectedPackage, reason };
//         localStorage.setItem('selectedPackage', JSON.stringify(selectedPackageDetails));

//         setQuery('');
//         setSelectedPackage('');
//         setReason('');

//         console.log('Submitted:', selectedPackageDetails);
//     };
